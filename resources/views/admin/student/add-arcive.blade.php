                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input style="display: none" name="student_id" type="text"
                                                    class="form-control" placeholder="ID" value="{{ $HighestID }}">
                                            </div>

                                            <div class="form-group">
                                                <label>Khmer name</label>
                                                <input name="khmer_name" type="text" class="form-control"
                                                    placeholder="Khmer name" value="{{ old('khmer_name') }}">
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="sex" class="form-control">
                                                    @foreach ($sex as $item)
                                                        <option value="{{ $item }}" @selected($item == old('sex'))>
                                                            {{ $item }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="father_occupation" type="text" class="form-control"
                                                    placeholder="Father occupation" value="{{ old('father_occupation') }}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="mother_occupation" type="text" class="form-control"
                                                    placeholder="Mother occupation" value="{{ old('mother_occupation') }}">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="english_name" type="text" class="form-control"
                                                    placeholder="English name" value="{{ old('english_name') }}">
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="facebook_or_email" type="text" class="form-control"
                                                    placeholder="facebook or email" value="{{ old('facebook_or_email') }}">
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="grade_id" class="form-control">
                                                    @foreach ($grades as $item)
                                                        <option value="{{ $item->id }}" @selected($item->id == old('grade_id'))>
